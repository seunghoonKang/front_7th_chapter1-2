...
### 4️⃣ 코드 작성 에이전트 (🟢 GREEN)

**파일**: `src/ai/agents/4-코드작성.md`

**역할**: TDD의 GREEN 단계 - 테스트를 통과시키는 최소 구현
...
### 5️⃣ 리팩터링 에이전트 (🔵 REFACTOR)

**파일**: `src/ai/agents/5-리팩터링.md`

**역할**: TDD의 REFACTOR 단계 - 코드 품질 개선
